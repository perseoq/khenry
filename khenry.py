...
def ventanaPrincipal():
    v = Tk()
    v.title("Khenry - Base de Conocimientos")
    v.geometry('480x540')
    v.resizable(0,0)
    n = Notebook(v)
    ...
    Label(tab1, text="El usuario es responsable por uso que le da a esta herramienta", font=("Georgia", 10)).grid(row=7, column=0)
    ...
    Button(tab4, text="Agregar").grid(row=23, column=0, columnspan=2, sticky='e', padx=10)
